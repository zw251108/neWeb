...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_debounce_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_throttle_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_merge_js__ = __webpack_require__(1);
...
class Listener {
  ...
  * */
	constructor(config = {}) {
		...
		this._config = Object(__WEBPACK_IMPORTED_MODULE_2__util_merge_js__["a" /* default */])(config, Listener._CONFIG);
  ...
  * */
	on(wait = 0) {
		...
		if (this._config.useDebounce && wait && wait > 0) {
			this._listener = Object(__WEBPACK_IMPORTED_MODULE_0__util_debounce_js__["a" /* default */])(this._queueExecute(), wait);
		} else if (this._config.useThrottle && wait && wait > 0) {
			this._listener = Object(__WEBPACK_IMPORTED_MODULE_1__util_throttle_js__["a" /* default */])(this._queueExecute(), wait);
		} else {
...
let listener = (target, type, callback = {}, options = {}) => {
	...
	opts = Object(__WEBPACK_IMPORTED_MODULE_2__util_merge_js__["a" /* default */])(opts, options);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listener_js__ = __webpack_require__(0);
...
class Model {
  ...
  * */
	constructor() {
		...
		this._listener = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])(this, 'modelChange', (e, topic, value) => {
  ...
  * */
	syncTo(model) {
		...
		model.forEach(d => {
			if (typeof d === 'object' && d instanceof Model && d.constructor !== this.constructor && this._syncList.indexOf(d) === -1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_maple__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_index_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_index_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__api_index_js__);




let z = __WEBPACK_IMPORTED_MODULE_0_maple__["a" /* default */];



z.api = __WEBPACK_IMPORTED_MODULE_1__api_index_js__;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tools_js__ = __webpack_require__(10);
...
dateFormat._dateStrReplace = {
  ...
  * */
	, MM(date) {
		return __WEBPACK_IMPORTED_MODULE_0__tools_js__["a" /* default */].fillZero(date.getMonth() + 1, 2);
	}
	/**
  * @summary 替换 DD
  * @param   {Date}      date
  ...
  * */
	, DD(date) {
		return __WEBPACK_IMPORTED_MODULE_0__tools_js__["a" /* default */].fillZero(date.getDate(), 2);
	}
	/**
  * @summary 替换 hh
  * @param   {Date}      date
  ...
  * */
	, hh(date) {
		return __WEBPACK_IMPORTED_MODULE_0__tools_js__["a" /* default */].fillZero(date.getHours(), 2);
	}
	/**
  * @summary 替换 mm
  * @param   {Date}      date
  ...
  * */
	, mm(date) {
		return __WEBPACK_IMPORTED_MODULE_0__tools_js__["a" /* default */].fillZero(date.getMinutes(), 2);
	}
	/**
  * @summary 替换 ss
  * @param   {Date}      date
  ...
  * */
	, ss(date) {
		return __WEBPACK_IMPORTED_MODULE_0__tools_js__["a" /* default */].fillZero(date.getSeconds(), 2);
	}
	/**
  * @summary 替换 www
  * @param   {Date}      date
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__listener_js__ = __webpack_require__(0);
...
class Url {
  ...
  * */
	constructor(url) {
		let a = document.createElement('a', __WEBPACK_IMPORTED_MODULE_0__config_js__["a" /* default */].ceKey);
 ...
 * @memberOf    url
 * */
url.hashChange = Object(__WEBPACK_IMPORTED_MODULE_1__listener_js__["b" /* listener */])('hashchange', (e, newUrl) => {
	let temp;
 ...
 * @memberOf    url
 * */
url.popState = Object(__WEBPACK_IMPORTED_MODULE_1__listener_js__["b" /* listener */])('popstate', (e, newUrl) => {
	let temp,
	    state = e.state;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listener_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_index_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__runtime_url_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__runtime_device_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_index_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_index_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__router_index_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__position_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__animate_index_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__register_index_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__notify_js__ = __webpack_require__(44);
...
let maple = {
  Listener: __WEBPACK_IMPORTED_MODULE_0__listener_js__["a" /* Listener */],
  listener: __WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */],
  util: __WEBPACK_IMPORTED_MODULE_1__util_index_js__["a" /* default */],

  url: __WEBPACK_IMPORTED_MODULE_2__runtime_url_js__["a" /* default */],
  device: __WEBPACK_IMPORTED_MODULE_3__runtime_device_js__["a" /* default */],

  Model: __WEBPACK_IMPORTED_MODULE_4__model_index_js__["a" /* default */],
  model: __WEBPACK_IMPORTED_MODULE_4__model_index_js__["a" /* default */],

  view: __WEBPACK_IMPORTED_MODULE_5__view_index_js__["a" /* default */],

  router: __WEBPACK_IMPORTED_MODULE_6__router_index_js__["a" /* default */],

  position: __WEBPACK_IMPORTED_MODULE_7__position_js__["a" /* default */]

  // 实验性功能
  , animate: __WEBPACK_IMPORTED_MODULE_8__animate_index_js__,
  register: __WEBPACK_IMPORTED_MODULE_9__register_index_js__["a" /* default */],
  notify: __WEBPACK_IMPORTED_MODULE_10__notify_js__["a" /* default */]
};

window.maple = maple;

/* harmony default export */ __webpack_exports__["a"] = (maple);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__debounce_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__throttle_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lockup_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__merge_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__dateFormat_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tools_js__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["a"] = ({
	debounce: __WEBPACK_IMPORTED_MODULE_0__debounce_js__["a" /* default */],
	throttle: __WEBPACK_IMPORTED_MODULE_1__throttle_js__["a" /* default */],
	lockup: __WEBPACK_IMPORTED_MODULE_2__lockup_js__["a" /* default */],

	merge: __WEBPACK_IMPORTED_MODULE_3__merge_js__["a" /* default */],
	dateFormat: __WEBPACK_IMPORTED_MODULE_4__dateFormat_js__["a" /* default */]
	// , validate
	, tools: __WEBPACK_IMPORTED_MODULE_5__tools_js__["a" /* default */]
});
...
/* harmony default export */ __webpack_exports__["a"] = (lockup);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cookie_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__localStorage_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sessionStorage_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__indexedDB_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__webSQL_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__service_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__webSocket_js__ = __webpack_require__(29);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_dateFormat_js__ = __webpack_require__(9);
 ...
 * */
class CookieModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
	/**
  * @constructor
  * */
	constructor() {
  ...
  * */
	static _transDate(date) {
		if (date instanceof Date) {} else {
			date = __WEBPACK_IMPORTED_MODULE_1__util_dateFormat_js__["a" /* default */].formatTimeStr(date);
  ...
  * */
	_setCookie(topic, value, options) {
		...
		document.cookie = encodeURIComponent(topic) + '=' + encodeURIComponent(this._stringify(value)) + Object.keys(CookieModel._DEFAULT).reduce((a, d) => {
			// 整理配置
 ...
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('cookie', CookieModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('cookie', 'c');

/* unused harmony default export */ var _unused_webpack_default_export = (CookieModel);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__model_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_merge_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__listener_js__ = __webpack_require__(0);
 ...
 * */
class LocalStorageModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
	/**
  * @constructor
  * @param   {Object}    [config={}]
  ...
  * */
	constructor(config = {}) {
		...
		this._config = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(config, LocalStorageModel._CONFIG);
  ...
  * */
	static listenOn() {
		...
		LocalStorageModel._globalStorage = Object(__WEBPACK_IMPORTED_MODULE_2__listener_js__["b" /* listener */])('storage', function (e) {
			let topic = e.key,
			    newVal = e.newValue,
			    oldVal = e.oldValue;
 ...
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('localStorage', LocalStorageModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('localStorage', 'ls');

/* unused harmony default export */ var _unused_webpack_default_export = (LocalStorageModel);
 ...
 * */
class SessionStorageModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
	/**
  * @constructor
  * */
	constructor() {
 ...
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('sessionStorage', SessionStorageModel);

/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('sessionStorage', 'ss');

/* unused harmony default export */ var _unused_webpack_default_export = (SessionStorageModel);
 ...
 * */
class IndexedDBModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
	/**
  * @constructor
  * @param   {Object}    [config={}]
  ...
  * */
	constructor(config = {}) {
		...
		this._config = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(config, IndexedDBModel._CONFIG);

		// this._store 为 Promise 类型，会在 resolve 中传入 db 实例，因为要保证数据库打开成功才可以操作
		this._store = new Promise((resolve, reject) => {
			let indexedDB, dbOpenRequest;
 ...
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('indexedDB', IndexedDBModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('indexedDB', 'idb');

/* unused harmony default export */ var _unused_webpack_default_export = (IndexedDBModel);
 ...
 * */
class WebSQLModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
	/**
  * @constructor
  * @param   {Object}    [config={}]
  * @param   {String}    [config.dbName]
  ...
  * */
	constructor(config = {}) {
		...
		this._config = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(config, WebSQLModel._CONFIG);

		if (sql && typeof sql === 'object') {

			this._config.sql = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(sql, WebSQLModel._CONFIG.sql);
		}
 ...
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('webSQL', WebSQLModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('webSQL', ['ws', 'sql']);

/* unused harmony default export */ var _unused_webpack_default_export = (WebSQLModel);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_merge_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_handlerQueue_js__ = __webpack_require__(28);
 ...
 * @todo 限制同时发送的请求的最大数量
 * */
class ServiceModel extends __WEBPACK_IMPORTED_MODULE_1__model_js__["a" /* default */] {
	/**
  * @constructor
  * @param   {Object}    [config={}]
  ...
  * */
	constructor(config = {}) {
		...
		this._config = Object(__WEBPACK_IMPORTED_MODULE_2__util_merge_js__["a" /* default */])(config, ServiceModel._CONFIG);

		this._syncTo = null;

		this.interceptor = {
			req: new __WEBPACK_IMPORTED_MODULE_3__util_handlerQueue_js__["a" /* default */](),
			res: new __WEBPACK_IMPORTED_MODULE_3__util_handlerQueue_js__["a" /* default */]()
		};
	}
  ...
  * */
	_setOpts(options) {
		return Object(__WEBPACK_IMPORTED_MODULE_2__util_merge_js__["a" /* default */])(options, {
			cache: false,
			dataType: 'json',
  ...
  * */
	syncTo(model) {
		...
		if (model instanceof __WEBPACK_IMPORTED_MODULE_1__model_js__["a" /* default */] && !(model instanceof ServiceModel)) {
			this._syncTo = model;
		}
	}
	/**
  ...
  * */
	request(topic, options) {
		...
		try {
			return __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax(topic, options).then(res => {
				// 请求成功
				return res;
			}, () => {
				// 请求失败
 ...
 * 特别标记 ServiceModel
 * */
__WEBPACK_IMPORTED_MODULE_1__model_js__["a" /* default */].ServiceModel = ServiceModel;

/**
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_1__model_js__["a" /* default */].register('service', ServiceModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_1__model_js__["a" /* default */].registerAlias('service', 's');

/* unused harmony default export */ var _unused_webpack_default_export = (ServiceModel);
...
/* harmony default export */ __webpack_exports__["a"] = (HandlerQueue);
 ...
 * @extends     Model
 * */
class WebSocketModel extends __WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */] {
  /**
   * @constructor
   * @param   {Object}    [config={}]
   * */
  constructor(config = {}) {
    ...
    this._config = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(config, WebSocketModel._CONFIG);
  }
}
 ...
 * 在 Model.factory 工厂方法注册，将可以使用工厂方法生成
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].register('webSocket', WebSocketModel);
/**
 * 注册别名
 * */
__WEBPACK_IMPORTED_MODULE_0__model_js__["a" /* default */].registerAlias('webSocket', 'socket');

/* unused harmony default export */ var _unused_webpack_default_export = (WebSocketModel);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__resize_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__scroll_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__deviceMotion_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__message_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__beforeunload_js__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__unload_js__ = __webpack_require__(36);
 ...
 * */
/* harmony default export */ __webpack_exports__["a"] = ({
	resize: __WEBPACK_IMPORTED_MODULE_0__resize_js__["a" /* default */],
	scroll: __WEBPACK_IMPORTED_MODULE_1__scroll_js__["a" /* default */],
	deviceMotion: __WEBPACK_IMPORTED_MODULE_2__deviceMotion_js__["a" /* default */],
	message: __WEBPACK_IMPORTED_MODULE_3__message_js__["a" /* default */]

	// , pageShow

	, beforeunload: __WEBPACK_IMPORTED_MODULE_4__beforeunload_js__["a" /* default */],
	unload: __WEBPACK_IMPORTED_MODULE_5__unload_js__["a" /* default */],
 ...
 * @type        {Listener}
 * */
let resize = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])('resize', {
  useDebounce: true
});
 ...
 * @type        {Listener}
 * */
let scroll = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])('scroll', {
	useDebounce: true
});
...
if (type) {
	deviceMotion = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])(type, {
		useDebounce: true
	});
}

/* harmony default export */ __webpack_exports__["a"] = (deviceMotion);
 ...
 * @type        {Listener}
 * */
let message = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])('message');
 ...
 * @type        {Listener}
 * */
let beforeunload = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])('before');

/* harmony default export */ __webpack_exports__["a"] = (beforeunload);
 ...
 * @type        {Listener}
 * */
let unload = Object(__WEBPACK_IMPORTED_MODULE_0__listener_js__["b" /* listener */])('unload');

/* harmony default export */ __webpack_exports__["a"] = (unload);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__runtime_url_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_merge_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__listener_js__ = __webpack_require__(0);
...
class Router {
  ...
  * */
	constructor(config = {}) {
		this.listener = Object(__WEBPACK_IMPORTED_MODULE_2__listener_js__["b" /* listener */])(this, 'routerChange', (e, newUrl, oldUrl) => {});
  ...
  * */
	init() {
		...
		if (__WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].hash) {
			tempUrl = __WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].parseUrl(__WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].hash);
  ...
  * */
	register(route, callback) {
		...
		if (typeof path === 'object' && path instanceof RegExp) {
			...
			if (!/^\//.test(path)) {
				// 当前目录下
				path = __WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].dir + path; // 添加根目录
			}
  ...
  * */
	get(path, params = {}) {
		let tempUrl = __WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].parseUrl(path);
		...
		return this.routers.map(route => {
			...
			if (result) {
				...
				temp = Object(__WEBPACK_IMPORTED_MODULE_1__util_merge_js__["a" /* default */])(temp, params);
				...
				try {
					...
					this.listener.trigger(__WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].pack(), tempUrl.pack());
				} catch (e) {
...
__WEBPACK_IMPORTED_MODULE_0__runtime_url_js__["a" /* default */].popState.add(() => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_merge_js__ = __webpack_require__(1);
...
let position = function (options = {}) {
	...
	if ('geolocation' in navigator) {
		result = new Promise(function (resolve, reject) {
			let opts = Object(__WEBPACK_IMPORTED_MODULE_0__util_merge_js__["a" /* default */])(options, position._CONFIG);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__animator_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__queue_js__ = __webpack_require__(40);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "animator", function() { return __WEBPACK_IMPORTED_MODULE_0__animator_js__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "queue", function() { return __WEBPACK_IMPORTED_MODULE_1__queue_js__["a"]; });
	...
	flush() {
		...
		if (this.animators.length) {
			(function play() {
				...
				if (animator instanceof __WEBPACK_IMPORTED_MODULE_0__animator_js__["a" /* default */]) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__serviceWorker_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__webWorker_js__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  serviceWorker: __WEBPACK_IMPORTED_MODULE_0__serviceWorker_js__["a" /* default */],
  webWorker: __WEBPACK_IMPORTED_MODULE_1__webWorker_js__["a" /* default */]
});
...
function registerServiceWorker(options = {}) {
	let config = Object(__WEBPACK_IMPORTED_MODULE_0__util_merge_js__["a" /* default */])(options, registerServiceWorker._CONFIG);
...
function registerWebWorker(options = {}) {
	let config = Object(__WEBPACK_IMPORTED_MODULE_0__util_merge_js__["a" /* default */])(options, registerWebWorker._CONFIG);
...
/* harmony default export */ __webpack_exports__["a"] = (registerWebWorker);
