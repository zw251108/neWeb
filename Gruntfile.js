		...
		, jsdoc: {
			...
			, frame: {
				...
				, src: [
					...
					, '../tiangou_web/javascript/libs/testFrame/animate/*.js'
					, '../tiangou_web/javascript/libs/testFrame/api/*.js'
					, '../tiangou_web/javascript/libs/testFrame/app/*.js'
					...
					, '../tiangou_web/javascript/libs/testFrame/runtime/*.js'
					, '../tiangou_web/javascript/libs/testFrame/util/*.js'
					, '../tiangou_web/javascript/libs/testFrame/view/*.js'
					, '../tiangou_web/javascript/libs/testFrame/worker/*.js'
					// , '../tiangou_web/javascript/libs/testFrame/demo/*.js'
					// 'src/lib/frame/*.js'
